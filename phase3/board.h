...
public:
    ...
    void show_member_lists(Member* user,string des_check,string cm_check,ostream& out);
    void filter_lists(vector<Member*> users,string des_check,string cm_check,ostream& out);
